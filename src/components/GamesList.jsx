...
class GamesList extends Component {
    ...
    constructor(props) {
      ...
      this.handleLeaveGameDialogClose = this.handleLeaveGameDialogClose.bind(this);
      this.handleAddGame = this.handleAddGame.bind(this);
      this.handleEnterGameDialogClose = this.handleEnterGameDialogClose.bind(this);
      this.handleCreateGameDialogClose = this.handleCreateGameDialogClose.bind(this);
        ...
        return (
            ...
            <div className={classes.list}>
              ...
              <div key={game.name}>
                <ListItem 
                  button
                  onClick={() => this.props.handleOpenGameView(game.name, this.props.token)}
                >
                <ListItemAvatar>
