...
class EnterGameDialog extends React.Component {
  ...
  handleButtonEnter() {
    this.props.handleEnterGame(this.state.gamename, this.props.username, this.props.token)
  ...
  render() {
    return (
      <div>
        ...
        >
          <DialogTitle id="alert-dialog-title">{"Enter Game"}</DialogTitle>
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              Type the name of the game you want to enter.
            </DialogContentText>
            <DialogContentText
                color = "error"
                align="center"
...
export default EnterGameDialog;
